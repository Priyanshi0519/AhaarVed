...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-background via-primary-light/20 to-success-light/10 flex items-center justify-center p-4">
...
//             <CardDescription>
//               Join thousands tracking their nutrition with AI
//             </CardDescription>
//           </CardHeader>
//           <CardContent>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-2xl font-bold">AhaarVed</h1>
          </div>
          <p>Start your AI-powered health journey</p>
        </div>
